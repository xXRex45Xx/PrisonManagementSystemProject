...
namespace PrisonManagementSystemProjectv0
{
    ...
    {       
        ...
        {
            DoctorInfo doctor = new DoctorInfo();
            return doctor.GetNumberOfDoctors();
        }

        public int GetNumberOfGuards()
        {
            GuardInfo guard = new GuardInfo();
            return guard.GetNumberOfGuards();
        }

        public int GetNumberOfReceptionists()
        {
            ReceptionInfo reception = new ReceptionInfo();
            return reception.GetNumberOfReceptionists();
        }

        public int GetNumberOfVisitors()
        {
            Visitor visitor = new Visitor();
            return visitor.GetNumberOfVisitors();
        }

        public DataTable GetDoctorTreatment(int doctorNo)
        {
            Treatment treatment = new Treatment();
            return treatment.SearchTreatment(doctorNo, "Doctor Number");
        }
