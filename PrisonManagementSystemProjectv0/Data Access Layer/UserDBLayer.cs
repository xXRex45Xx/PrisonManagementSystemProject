...
namespace PrisonManagementSystemProjectv0
{
    ...
    {
        private static string _connectionString = "server=localhost;database=PrisonDatabase;uid=esrom;pwd=esrom;";       
        ...
        public int ResetUserCredentials(string oldUserName, User newUser)
        {
            try
            {
                using(SqlConnection connection = new SqlConnection(_connectionString))
