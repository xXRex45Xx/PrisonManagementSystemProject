    ...
    {        
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (u.Login())
                {
                    DialogResult logout = DialogResult.No;
                    this.Hide();
                    if (u.Role.Equals("Administrator"))
                    {
                        ...
                        logout = administratorForm.ShowDialog();
                    }
                    ...
                    else if (u.Role.Equals("Reception"))
                    {
                        ...
                        logout = receptionForm.ShowDialog();
                    }
                    if (logout.Equals(DialogResult.Yes))
                    {
                        this.Show();
                        btnLogin.Focus();
                    }
